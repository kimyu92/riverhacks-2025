...
import { MapPin, MessageSquare, Bell, Search, Accessibility, Server } from "lucide-react";
...
export default function Home() {
  ...
  const handleSearch = () => {
    ...
    navigate(`/results?resourceType=${activeBadge}&zipCode=${zipCode}`);
  };
      ...
      <section className="bg-[#38A054] text-[#002939] py-12 px-4">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg mb-4">
            Quickly locate shelters, food banks and cooling stations and more
            around Austin, TX
          </p>
